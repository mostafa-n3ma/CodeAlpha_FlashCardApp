...
import com.example.codealpha_flashcardapp.MainActivity.Companion.firebaseAuth
...
@Composable
fun SignUpScreen(navController: NavController, authStatus: FirebaseAuth) {
    Column(
        modifier = Modifier
            .fillMaxSize()
...
@Composable
fun SignUpPreview() {
    SignUpScreen(navController = rememberNavController(), authStatus = firebaseAuth)
}
